...
- Monitors live in `hypr/config/monitors.lua`, hand-written — matched by `desc:` (EDID make/model), positioned relatively (`auto-center-*`) so all setups share one file. Don't use nwg-displays; `monitors.conf` is gone.
